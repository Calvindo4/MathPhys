...
class Shooter {
    ...
    public Shooter() {
        ...
        controlPanel.setBounds(3, 1, cpWidth, 300);
        frame.add(controlPanel);

        // setup velocity
        JLabel velocitylabel = new JLabel ("Set Velocity");
        JTextField velocityField = new JTextField("50", 8);
        controlPanel.add(velocitylabel);
        controlPanel.add(velocityField);
        frame.add(bulletVelocity);

        // setup wind
        JLabel windForceLabel = new JLabel ("Set Wind's Force");
        JTextField windForceField = new JTextField("20", 8);
        controlPanel.add(windForceLabel);
        controlPanel.add(windForceField);
        frame.add(windForceLabel);
    ...
    class Bullet {
        ...
        public Bullet(double radius, int originX, int originY, double angle, double timeInitial) {
            ...
            double acceleration = windForce / mass;
            this.accelerationX = acceleration * Math.cos(Math.toRadians(windDirection));
            this.accelerationX = acceleration * Math.sin(Math.toRadians(windDirection) * gravity);
        ...
        void move(double time) {
            ...
            positionX = (int) (originX + (velocityX * currentTime + accelerationX * currentTime * currentTime / 2));
            positionY = (int) (originY - (velocityY * currentTime + accelerationY * currentTime * currentTime / 2));
        }
